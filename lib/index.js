(function (global, factory) {
    ...
    function RouterRoute({ routeInfo, path, routeNamedParams, urlParser, namedPath, language }) {
      ...
      const get = () => {
        return {
          ...
          asyncComponent: routeInfo.asyncComponent,
          hash: urlParser.hash,
    ...
    /* src/components/route.svelte generated by Svelte v3.38.3 */
    ...
    function create_if_block_1(ctx) {
    	...
    	handle_promise(promise = /*currentRoute*/ ctx[0].asyncComponent(), info);
    	...
    	return {
    		...
    		p(new_ctx, dirty) {
    			...
    			if (dirty & /*currentRoute*/ 1 && promise !== (promise = /*currentRoute*/ ctx[0].asyncComponent()) && handle_promise(promise, info)) ; else {
    ...
    // (1:0) <script>   export let currentRoute = {}
    ...
    // (9:47)      <svelte:component this={c.default}
    ...
    function create_fragment$2(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		...
    		if (/*currentRoute*/ ctx[0].asyncComponent) return 1;
    		if (/*currentRoute*/ ctx[0].component) return 2;
    		if (/*currentRoute*/ ctx[0].childRoute) return 3;
    		return -1;
    	}
    ...
    /* src/components/router.svelte generated by Svelte v3.38.3 */
    ...
    /* src/components/navigate.svelte generated by Svelte v3.38.3 */
